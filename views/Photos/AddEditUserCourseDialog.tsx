...
function AddEditUserCourseDialogForm({
  ...
  const { addUserCourse } = useUserCourse();
      ...
      <>
        <DialogContent>
          <Stack
            direction="column"
            spacing={3}
            sx={{ alignItems: "center", p: 2, textAlign: "center" }}
          >
            <Typography variant="h5">
              <b>{"Add Your Child's Name"}</b>
            </Typography>
            <Typography variant="body1" sx={{ fontWeight: 300 }}>
              Enter your child’s name to access their class photos. If you have
              more than one child in this class, you can add their names too.
            </Typography>
            <Box
              sx={{
                background: "#ECEDEF",
        ...
        >
          ...
          <Box>
            <Typography variant="body2" sx={{ fontWeight: 300 }}>
              Please obtain the passcode from the class teacher or the relevant
              authority.
            </Typography>
            <Typography variant="body2" sx={{ fontWeight: 300 }}>
            ...
            <Typography variant="body2" sx={{ fontWeight: 300 }}>
              • If you need access to photos from previous years, please contact
              us for assistance.
            </Typography>
          </Box>
        </Stack>
